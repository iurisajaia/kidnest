<div class="w-full md:w-6/12 border border-gray-200 rounded-lg shadow">
    ...
    >
        ...
        <div class="w-full gap-[16px]">
            <div class="pb-4">
                @include('components.global.input.standard', ['placeholder' => __('new.password'), 'name' => 'password', 'type' => 'password'])
                @error('password')
                <span>{{$message}}</span>
                @enderror
            </div>
            <div class="pb-4">
                @include('components.global.input.standard', ['placeholder' => __('confirm.password'), 'name' => 'password_confirmation', 'type' => 'password'])
