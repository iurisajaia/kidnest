<div class="py-[16px] px-[16px] flex items-center">
    <input id="default-checkbox-{{$kid->id}}" type="checkbox" data-activity-id="{{$activity['id']}}" name="parent_id[]" value="{{$kid?->getParent()['id']}}" class="parent-input w-[20px] h-[20px] mr-[24px] ">
