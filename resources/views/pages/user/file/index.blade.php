                                    ...
                                    <div data-simplebar class="h-100">
                                        <div class="card-body d-flex flex-column h-100">
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <div
                                                    class="dropzone file-dropzone border border-1 border-dashed border-primary text-center">
                                                    <div class="fallback">
                                                    ...
                                                    <div class="dz-message needsclick">
                                                        ...
                                                        <h5 class="fs-md mb-0 text-primary">Drop files here or click to
                                                            upload.</h5>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <ul class="file-manager-menu list-unstyled fs-md mb-0">
                                                    <li>
                                                        <a href="#!"><i class="ti ti-folder align-baseline me-1"></i>
                                                            All Folders</a>
                                                    </li>
                                                    <li>
                                                        <div class="custom-accordion">
                                                            <a class="text-body fw-medium py-1 d-flex align-items-center"
                                                               ...
                                                               aria-controls="categories-collapse">
                                                                <i class="ti ti-clock-hour-2 font-size-20  me-2"></i>
                                                                Recent File <i
                                                                    class="ti ti-chevron-down accor-down-icon ms-auto"></i>
                                                            </a>
                                                                    ...
                                                                    <ul class="list-unstyled mb-0">
                                                                        <li><a href="#"
                                                                               class="d-flex align-items-center text-muted"><i
                                                                                    class="bi bi-circle-fill text-danger me-2"
                                                                                    style="font-size: 6px;"></i><span
                                                                                    class="me-auto">Analytics</span></a>
                                                                        </li>
                                                                        <li><a href="#"
                                                                               class="d-flex align-items-center text-muted"><i
                                                                        ...
                                                                        <li><a href="#"
                                                                               class="d-flex align-items-center text-muted"><i
                                                                                    class="bi bi-circle-fill text-info me-2"
                                                                                    style="font-size: 6px;"></i><span
                                                                                    class="me-auto">Development</span>
                                                                                <i class="ti ti-flag-3-filled ms-auto"></i></a>
                                                                        </li>
                                                                        <li><a href="#"
                                                                               class="d-flex align-items-center text-muted"><i
                                                                        ...
                                                                        <li><a href="#"
                                                                               class="d-flex align-items-center text-muted"><i
                                                                                    ...
                                                                                    class="ti ti-flag-3-filled ms-auto"></i></a>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <li>
                                                        <a href="#!"><i
                                                                class="ti ti-brand-youtube align-baseline me-1"></i>
                                                            Videos</a>
                                                    </li>
                                                    <li>
                                                        <a href="#!"><i
                                                                class="ti ti-file-description align-baseline me-1"></i>
                                                            Documents</a>
                                                    </li>
                                                    <li>
                                                        <a href="#!"><i class="ti ti-photo align-baseline me-1"></i>
                                                            Images</a>
                                                    </li>

                                                    <li>
                                                        <a href="#!"><i class="ti ti-star align-baseline me-1"></i>
                                                            Important</a>
                                                    </li>
                                                </ul>
                                            </div>
                                            <div class="mb-4">
                                                ...
                                                <ul class="file-manager-menu list-unstyled">
                                                    <li>
                                                        <a href="#!"><i class="ti ti-bookmark align-baseline me-1"></i>
                                                            DOC - Projectbaser.word</a>
                                                    </li>
                                                    <li>
                                                        <a href="#!"><i class="ti ti-bookmark align-baseline me-1"></i>
                                                            DOC - SkripsiOnky.word</a>
                                                    </li>
                                                    <li>
                                                        <a href="#!"><i class="ti ti-bookmark align-baseline me-1"></i>
                                                            IMG - auth-bg.jpg</a>
                                            ...
                                            <div class="card bg-primary-subtle file-manager-widgets mt-auto mb-0">
                                                <div class="card-body">
                                                    <div class="text-center mt-n5">
                                                        <img src="assets/images/upgrade-filemanager.png" alt=""
                                                             height="200">
                                                        <h6 class="mt-4">Get more space for files</h6>
                                                        <p class="text-muted fs-sm">We offer you unlimited storage space
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex gap-3 align-items-center mb-3">
                                            <div class="flex-shrink-0 d-block d-lg-none">
                                                <button type="button"
                                                        class="btn btn-icon btn-subtle-success file-menu-btn">
                                            ...
                                            <div class="flex-shrink-0">
                                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                                        data-bs-target="#createFolder"><i
                                                        class="bi bi-plus-lg align-baseline"></i> <span
                                                        class="ms-1 d-none d-sm-inline-block">Create Folders</span>
                                                </button>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col">
                                                <a href="#!" class="card">
                                                    <div class="card-body d-flex align-items-center gap-3 p-2">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <p class="flex-grow-1 mb-0 text-muted"><b>3124</b> Images
                                                            </p>
                                                        </div>
                                                    </div>
                                                </a>
                                            ...
                                            <div class="col">
                                                <a href="#!" class="card">
                                                    <div class="card-body d-flex align-items-center gap-3 p-2">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <p class="flex-grow-1 mb-0 text-muted"><b>469</b> Docs Files
                                                            </p>
                                                        </div>
                                                    </div>
                                                </a>
                                            ...
                                            <div class="col">
                                                <a href="#!" class="card">
                                                    <div class="card-body d-flex align-items-center gap-3 p-2">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <p class="flex-grow-1 mb-0 text-muted"><b>18</b> Application
                                                            </p>
                                                        </div>
                                                    </div>
                                                </a>
                                            ...
                                            <div class="flex-shrink-0 dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li><a class="dropdown-item" href="#"><i
                                                                class="bi bi-folder-plus me-1 align-baseline"></i> Add
                                                            Folder</a></li>
                                                    <li><a class="dropdown-item" href="#"><i
                                                                class="bi bi-cloud-arrow-down me-1 align-baseline"></i>
                                                            Import</a></li>
                                                    <li><a class="dropdown-item" href="#"><i
                                                                class="bi bi-cloud-arrow-up me-1 align-baseline"></i>
                                                            Export</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="card-body">
                                                        <div class="d-flex gap-3 mb-4">
                                                            ...
                                                            <div class="flex-shrink-0 dropdown">
                                                                ...
                                                                <ul class="dropdown-menu dropdown-menu-end">
                                                                    <li><a class="dropdown-item" href="#"><i
                                                                                class="bi bi-folder2-open me-1 align-baseline"></i>
                                                                            Open Folder</a></li>
                                                                    <li><a class="dropdown-item" href="#"><i
                                                                                class="bi bi-pencil-square me-1 align-baseline"></i>
                                                                            Edit</a></li>
                                                                    <li><a class="dropdown-item" href="#"><i
                                                                                class="bi bi-trash3 me-1 align-baseline"></i>
                                                                            Delete</a></li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="card border shadow-none">
                                                    <div class="card-body">
                                                        ...
                                                        <a href="#!">
                                                            <h6 class="fs-md text-truncate">Steex - Admin & Dashboard
                                                                Templates</h6>
                                                        </a>
                                                        <ul class="list-unstyled hstack gap-2 text-muted mb-0">
                                                            <li>
                                                    ...
                                                    <div class="card-body">
                                                        <div class="d-flex gap-3 align-items-center">
                                                            <div class="avatar-sm flex-shrink-0">
                                                                <div
                                                                    class="avatar-title bg-body-secondary rounded fs-5">
                                                                    <i class="ti ti-file align-middle text-primary"></i>
                                                                </div>
                                                            </div>
                                                            <div class="flex-grow-1">
                                                                <h6 class="text-white fs-md">Sprix.docs</h6>
                                                                <p class="text-white text-opacity-50 fs-sm mb-0">256
                                                                    KB</p>
                                                            </div>
                                                            <div class="flex-shrink-0 dropdown">
                                                ...
                                                <div class="card border shadow-none">
                                                    <div class="card-body">
                                                        <div class="d-flex gap-3 align-items-center">
                                                            <div class="avatar-sm flex-shrink-0">
                                                                <div
                                                                    class="avatar-title bg-success-subtle rounded fs-5">
                                            ...
                                            <div class="d-flex align-items-center gap-2 mb-3">
                                                ...
                                                <div
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <button class="dropdown-item sort" data-sort="docs_type">Docs
                                                            Type
                                                        </button>
                                                        <button class="dropdown-item sort" data-sort="size">Size
                                                        </button>
                                                        <button class="dropdown-item sort" data-sort="date">Date
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <table
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th scope="col" class="sort cursor-pointer"
                                                            data-sort="docs_type">Type
                                                        </th>
                                                        <th scope="col" class="sort cursor-pointer"
                                                            data-sort="document_name">Document Name
                                                        </th>
                                                        <th scope="col" class="sort cursor-pointer"
                                                            data-sort="file_item">File Item
                                                        </th>
                                                        <th scope="col" class="sort cursor-pointer" data-sort="size">
                                                            Size
                                                        </th>
                                                    ...
                                                    <tr>
                                                        <th>
                                                            <div class="form-check checkbox-product-list">
                                                                <input class="form-check-input" type="checkbox"
                                                                       value="2" id="checkbox-2">
                                                                <label class="form-check-label"
                                                                       for="checkbox-2"></label>
                                                            </div>
                                                        </th>
                                                        <td class="docs_type">
                                                        ...
                                                        <td>
                                                            <a href="#!" class="text-reset document_name">Velzon Docs
                                                                File</a>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="#!" class="text-reset document_name">Steex Design
                                                                Kit.psd</a>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <th>
                                                            <div class="form-check checkbox-product-list">
                                                                <input class="form-check-input" type="checkbox"
                                                                       value="4" id="checkbox-4">
                                                                <label class="form-check-label"
                                                                       for="checkbox-4"></label>
                                                            </div>
                                                        </th>
                                                        <td class="docs_type">
                                                    ...
                                                    <tr>
                                                        <th>
                                                            <div class="form-check checkbox-product-list">
                                                                <input class="form-check-input" type="checkbox"
                                                                       value="4" id="checkbox-5">
                                                                <label class="form-check-label"
                                                                       for="checkbox-5"></label>
                                                            </div>
                                                        </th>
                                                        <td class="docs_type">
                                                        ...
                                                        <td>
                                                            <a href="#!" class="text-reset document_name">Offline
                                                                Pages.gif</a>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <th>
                                                            <div class="form-check checkbox-product-list">
                                                                <input class="form-check-input" type="checkbox"
                                                                       value="4" id="checkbox-6">
                                                                <label class="form-check-label"
                                                                       for="checkbox-6"></label>
                                                            </div>
                                                        </th>
                                                        <td class="docs_type">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="#!" class="text-reset document_name">home Pattern
                                                                Wave.svg</a>
                                                        </td>
                                                        <td class="file_item">01</td>
                                                        <td class="size">
                                            ...
                                            <div class="row align-items-center text-center text-sm-start mt-3">
                                                <div class="col-sm">
                                                    <div class="text-muted">
                                                        Showing <span class="fw-semibold">8</span> of <span
                                ...
                                <div class="card file-manager-right-wrapper rounded-start-0 shadow-none">
                                    <div data-simplebar class="h-100">
                                        <div class="card-header d-flex gap-2 align-items-center">
                                            <div class="flex-grow-1">
                                                <h6 class="card-title mb-0">Storage Overview <span
                                                        class="badge bg-success-subtle text-success align-middle ms-1">67%</span>
                                                </h6>
                                            </div>
                                            <div class="flex-shrink-0">
                                                <button type="button"
                                        ...
                                        <div class="card-body">
                                            <div id="storage_chart" data-colors='["--tb-success"]' class="apex-charts"
                                                 dir="ltr"></div>
                                            <div class="mt-3 mb-3">
                                                            ...
                                                            <div class="d-flex gap-3 align-items-center mb-3">
                                                                ...
                                                                <div class="flex-grow-1">
                                                                    ...
                                                                    <div class="d-flex mt-2">
                                                                        <p class="text-muted flex-grow-1 mb-0">1,324
                                                                            Files</p>
                                                                        <div class="fw-medium flex-shrink-0">14.5GB
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="card-body">
                                                            <div class="d-flex gap-3 align-items-center mb-3">
                                                                ...
                                                                <div class="flex-grow-1">
                                                                    ...
                                                                    <div class="d-flex mt-2">
                                                                        <p class="text-muted flex-grow-1 mb-0">210
                                                                            Files</p>
                                                                        <div class="fw-medium flex-shrink-0">1.23 GB
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="card-body">
                                                            <div class="d-flex gap-3 align-items-center mb-3">
                                                                ...
                                                                <div class="flex-grow-1">
                                                                    ...
                                                                    <div class="d-flex mt-2">
                                                                        <p class="text-muted flex-grow-1 mb-0">102
                                                                            Files</p>
                                                        ...
                                                        <div class="card-body">
                                                            <div class="d-flex gap-3 align-items-center mb-3">
                                                                ...
                                                                <div class="flex-grow-1">
                                                                    ...
                                                                    <div class="d-flex mt-2">
                                                                        <p class="text-muted flex-grow-1 mb-0">154
                                                                            Files</p>
                                                                        <div class="fw-medium flex-shrink-0">2.7 GB
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="card-body">
                                                            <div class="d-flex gap-3 align-items-center mb-3">
                                                                ...
                                                                <div class="flex-grow-1">
                                                                    ...
                                                                    <div class="d-flex mt-2">
                                                                        <p class="text-muted flex-grow-1 mb-0">30
                                                                            Files</p>
                                                            ...
                                                            <div class="progress progress-sm">
                                                                <div class="progress-bar" role="progressbar"
                                                                     style="width: 71%;" aria-valuenow="71"
                                                                     aria-valuemin="0" aria-valuemax="100"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                    ...
                    <form class="tablelist-form" novalidate autocomplete="off">
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="product-category-input" data-choices
...
@endsection
@push('styles')
    <link rel="stylesheet" href="{{asset('js/file-manager/dropzone/dropzone.css')}}" type="text/css">

    <!-- Layout config Js -->
    <script src="{{asset('js/file-manager//layout.js')}}"></script>
    <!-- Bootstrap Css -->
    <link href="{{asset('css/file-manager/bootstrap.min.css')}}" rel="stylesheet" type="text/css">
    <!-- Icons Css -->
    <link href="{{asset('css/file-manager/icons.min.css')}}" rel="stylesheet" type="text/css">
    <!-- App Css-->
    <link href="{{asset('css/file-manager/app.min.css')}}" rel="stylesheet" type="text/css">
    <!-- custom Css-->
    <link href="{{asset('css/file-manager/custom.min.css')}}" rel="stylesheet" type="text/css">
@endpush
@push('scripts')
    <script src="{{asset('js/file-manager/bootstrap/js/bootstrap.bundle.min.js')}}"></script>
    <script src="{{asset('js/file-manager/simplebar/simplebar.min.js')}}"></script>
    <script src="{{asset('js/file-manager/plugins.js')}}"></script>

    <!-- dropzone min -->
    <script src="{{asset('js/file-manager/dropzone/dropzone-min.js')}}"></script>

    <script src="{{asset('js/file-manager/list.js/list.min.js')}}"></script>

    <!-- apexcharts js -->
    <script src="{{asset('js/file-manager/apexcharts/apexcharts.min.js')}}"></script>

    <script src="{{asset('js/file-manager/pages/file-manager.init.js')}}"></script>

    <!-- App js -->
    <script src="{{asset('js/file-manager/app.js')}}"></script>
@endpush
